// src/Harbor.Protocol/Opcode.cs 와 **한 글자도 다르면 안 된다.**
// C→S < 0x1000, S→C >= 0x1000.

export const Op = {
  // Client → Server
  C_Login: 0x0001, C_Ping: 0x0002,
  C_EnterRoom: 0x0010, C_LeaveRoom: 0x0011, C_RoomList: 0x0012, C_UpgradeRoom: 0x0013,
  C_HouseList: 0x0014, C_RemodelRoom: 0x0015, C_SetRoomStyle: 0x0016,
  C_Move: 0x0020, C_Action: 0x0021, C_SetFigure: 0x0022,
  C_Chat: 0x0030, C_Whisper: 0x0031,
  C_PlaceItem: 0x0040, C_PickItem: 0x0041, C_MoveItem: 0x0042, C_UseItem: 0x0043, C_OfferItem: 0x0044,
  ...
  S_RoomSnapshot: 0x1010, S_UserEnter: 0x1011, S_UserLeave: 0x1012,
  S_RoomList: 0x1013, S_HouseList: 0x1014, S_RoomStyle: 0x1015,
...
/** 로그·디버깅용 이름. 모르는 opcode 는 16진수로. */
const NAMES = new Map<number, string>(Object.entries(Op).map(([k, v]) => [v as number, k]));
export const opName = (op: number) => NAMES.get(op) ?? `0x${op.toString(16).padStart(4, "0")}`;
